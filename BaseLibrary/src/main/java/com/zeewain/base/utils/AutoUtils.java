...
public class AutoUtils {
	...
	public static void setSize(Activity act, boolean hasStatusBar, int designWidth, int designHeight){
        ...
        act.getWindowManager().getDefaultDisplay().getRealMetrics(outMetrics);
    ...
    public static void autoSize(View view){
		...
		//keep view squre based on width
		if(lp.height == lp.width){
			lp.height = lp.width;
		}
    }
	...
	public static float getTextSizeByPx(float textPx) {
		return (float) (textPixelsRate * textPx);
	}
