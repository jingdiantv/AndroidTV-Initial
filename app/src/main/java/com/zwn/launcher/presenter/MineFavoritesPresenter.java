...
public class MineFavoritesPresenter extends Presenter {
    private static final String TAG = "MineFavoritesPresenter";
    ...
    public void onBindViewHolder(Presenter.ViewHolder viewHolder, Object item) {
        if (item instanceof MineCommonMo) {
            ...
            if (model.type.equals(ProdConstants.MY_FAVORITES)) {
                vh.imageView.setBackgroundResource(R.mipmap.ic_all_collect);
            } else {
