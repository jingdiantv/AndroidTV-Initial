...
public class MineHistoryPresenter extends Presenter {
    ...
    public void onBindViewHolder(Presenter.ViewHolder viewHolder, Object item) {
        if (item instanceof MineCommonMo) {
            ...
            if (model.type.equals(ProdConstants.INTERACTIVE_RECORD)) {
                vh.imageView.setBackgroundResource(R.mipmap.ic_all_record);
            } else {
